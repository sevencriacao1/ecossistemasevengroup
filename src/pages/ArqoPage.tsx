  ...
  return (
    ...
    >
      <header className="fixed left-0 right-0 top-0 z-50 px-4 py-4 sm:px-6">
        ...
        <div
          className={cn(
            'browser-stable-surface mx-auto mt-2 grid max-w-7xl 3xl:max-w-9xl gap-1 overflow-hidden rounded-[24px] border border-black/[0.06] bg-white/88 p-2 shadow-[0_18px_54px_rgba(34,33,29,0.08)] backdrop-blur-2xl transition-all lg:hidden',
      ...
      <a
        href="#topo"
        className="browser-stable-surface fixed bottom-5 right-5 z-40 flex h-12 w-12 items-center justify-center rounded-full border border-black/[0.08] bg-white/72 text-[#171715] shadow-[0_18px_44px_rgba(34,33,29,0.12)] backdrop-blur-2xl transition hover:-translate-y-1 hover:bg-white"
