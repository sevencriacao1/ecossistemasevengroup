  ...
  useGSAP(
    () => {
      ...
      if (prefersReducedMotion) {
        gsap.set([logoCard, incorpCard, selectCard, ecosystemConnector, finalText], { clearProps: 'all', autoAlpha: 1, x: 0, y: 0, scale: 1 });
        gsap.set([...incorpBulletsNodes, ...selectBulletsNodes, ...backContentNodes], { clearProps: 'all', autoAlpha: 1, y: 0 });
        gsap.set(ecosystemPaths, { strokeDashoffset: 0 });
        gsap.set(finalChars, { color: 'rgba(22,22,21,1)' });
        return;
      }
      ...
      gsap.set([incorpFlipper, selectFlipper], { rotateY: 0, z: 0, transformStyle: 'preserve-3d' });
      ...
      const createTimeline = () => {
        ...
        timeline
          ...
          .to(incorpFlipper, { rotateY: 180, z: 0, duration: 0.24, ease: 'power2.inOut' }, 1.02)
          .to(selectFlipper, { rotateY: 180, z: 0, duration: 0.24, ease: 'power2.inOut' }, 1.08)
  ...
  return (
    <article
      ...
      className={[
        ...
        .join(' ')}
    >
      <div data-card-flipper className="arqo-concept-flipper absolute inset-0 will-change-transform">
        <div className="arqo-concept-face absolute inset-0 overflow-hidden border border-black/[0.065] bg-[#F8F7F3]/94 p-7 shadow-[0_24px_70px_rgba(34,33,29,0.045)] backdrop-blur-xl sm:p-8 lg:p-7 xl:p-8">
        ...
        <div className="arqo-concept-face arqo-concept-face-back absolute inset-0 overflow-hidden border border-black/[0.065] bg-[#F8F7F3]/96 p-6 shadow-[0_24px_70px_rgba(34,33,29,0.045)] backdrop-blur-xl sm:p-8">
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(22,22,21,0.04)_1px,transparent_1px),linear-gradient(90deg,rgba(22,22,21,0.034)_1px,transparent_1px)] bg-[size:42px_42px] opacity-70" />
