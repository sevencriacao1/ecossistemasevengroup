...
export function SevenHero() {
  ...
  return (
    <section ref={ref} className="relative min-h-[100svh] overflow-hidden bg-[#F7F7F8] px-5 py-[clamp(6.5rem,12svh,9rem)] text-[#111114] sm:px-8 lg:px-10">
      <motion.div
        style={{ y, opacity }}
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100svh-13rem)] max-w-7xl items-center gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(360px,0.95fr)]">
        <motion.div
        ...
        <motion.div
          ...
          className="relative min-h-[360px] sm:min-h-[430px] lg:min-h-[min(560px,calc(100svh-12rem))]"
        >
