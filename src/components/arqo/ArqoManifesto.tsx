  ...
  return (
    <ArqoSection id="manifesto" className="bg-white py-24 lg:py-36">
      <div ref={ref} className="relative">
        <div className="pointer-events-none absolute -left-10 top-0 hidden h-full w-px bg-gradient-to-b from-transparent via-black/10 to-transparent lg:block" />

        <div className="grid gap-16 lg:grid-cols-[0.34fr_0.66fr] lg:items-start">
          ...
          <article className="relative">
            <div className="grid gap-8 border-b border-black/[0.08] pb-14 lg:grid-cols-[0.64fr_0.36fr] lg:items-end">
              <div>
                ...
                <StableTextReveal
                  ...
                  as="h2"
                  className="arqo-heading max-w-4xl text-balance text-5xl font-medium leading-[0.98] tracking-[-0.055em] text-[#171715] sm:text-7xl lg:text-[clamp(4.8rem,7.2vw,8.4rem)]"
                />
              </div>
            ...
            <div className="relative grid gap-10 py-14 lg:grid-cols-[0.48fr_0.04fr_0.48fr] lg:gap-8 lg:py-20">
              ...
              <motion.div style={{ y: clarityY }} className="relative lg:pt-20">
            ...
            <div className="relative overflow-hidden bg-[#171715] px-6 py-10 text-white sm:px-10 lg:px-12">
              ...
              <div className="relative grid gap-8 lg:grid-cols-[0.25fr_0.75fr] lg:items-center">
